...
if st.session_state.part_no is None:
    ...
    uploaded_file = st.file_uploader("📁 Upload barcode photo", type=['png', 'jpg', 'jpeg', 'webp'], label_visibility="collapsed")
    ...
    if uploaded_file is not None:
        ...
        if part_no:
            ...
            st.success(f"✅ **Part No: {part_no}**")
            st.balloons()
            st.rerun()  # Auto-close after detection
        else:
            st.warning("⚠️ No barcode detected. Try a clearer image.")
